...
//TODO: bh组件如何与ons组件融合
import BhSteppingElement from './elements/bh/bh-step';
import BhInputElement from './elements/bh/bh-input';
import BhSearchElement from './elements/bh/bh-search';
import BhSearchBarElement from './elements/bh/bh-search-bar';
import BhInputSelectElement from './elements/bh/bh-input-select';
import BhCarouselBtnsElement from './elements/bh/bh-carousel-btns';
import BhModalBottomElement from './elements/bh/bh-modal-bottom';
import './elements/bh/bh-modal-bottom-command';
import BhSelectRollElement from './elements/bh/bh-select-roll';
